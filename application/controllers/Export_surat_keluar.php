...
class Export_surat_keluar extends CI_Controller {
	...
	function __construct()
	{
			...
			$this->load->model('m_surat_keluar','m_nd');
	...
	public function index(){
		$data['jenis_surat'] = $this->m_nd->get_jenis();
		$this->load->view('_template/header');
		$this->load->view('_template/sidebar');
		$this->load->view('modul/eksport_surat_keluar/view',$data);
	...
	public function print($data){
		...
		echo "</head>";
		echo "<body>";
		echo "<center><h4>Daftar Surat Keluar</h4></center>";
	...
	public function export($data){
    	...
    	header("Content-Disposition: attachment; filename=Daftar_Surat_Keluar.xls");
		echo "<html>";
		echo "<head>";
		echo "<style>";
		// echo "@media print {
