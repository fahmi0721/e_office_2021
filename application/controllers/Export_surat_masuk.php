...
class Export_surat_masuk extends CI_Controller {
	...
	function __construct()
	{
			...
			$this->load->model('m_surat_masuk','m_nd');
	...
	public function index(){
		...
		$this->load->view('modul/eksport_surat_masuk/view');
	...
	public function print($data){
		...
		echo "</head>";
		echo "<body>";
		echo "<center><h4>Daftar Surat Masuk</h4></center>";
		...
		echo "<tr>";
			...
			echo "<th>Tanggal Masuk Surat</th>";
			echo "<th>Perihal</th>";
		...
		echo "<tbody>";
			...
			foreach($iData as $dt){
				echo "<tr>";
					...
					echo "<td style='text-align:center; width:10%'>".$dt->TglMasukSurat."</td>";
	...
	public function export($data){
    	...
    	header("Content-Disposition: attachment; filename=Daftar_Surat_Masuk.xls");
		echo "<html>";
		echo "<head>";
		echo "<style>";
		// echo "@media print {
