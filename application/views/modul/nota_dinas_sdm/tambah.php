  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Modul Nota Dinas Khusus
        <small>Tambah Nota Dinas Khusus</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?= base_url() ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?= base_url('nota_dinas/index/') ?>"><i class="fa fa-users"></i> Detail Nota Dinas</a></li>
        <li class="active">Tambah Nota Dinas Khusus</li>
    ...
    <section class="content">
      ...
      <div class="box box-danger">
        <div class="box-header with-border">
          <h3 class="box-title">Tambah Nota Dinas Khusus</h3>
                    ...
                    <div class='col-sm-9 col-md-8'>
                        ...
                        <div class="form-group">
                            ...
                            <div class='col-sm-6'>
                                ...
                                <select class='form-control FormInput select select-dari' onchange='getNomorSurat()' name='Dari' id='Dari'>
                                        <option value="">Pilih Tujuan</option>
                                        <?php foreach($kepada as $kp){ ?>
                                        <option value="<?= $kp->Kode ?>#<?= $kp->Nama ?>"><?= $kp->Nama; ?></option>
                                        <?php } ?>
  ...
  <?php $this->load->view('modul/nota_dinas_sdm/js'); ?>
