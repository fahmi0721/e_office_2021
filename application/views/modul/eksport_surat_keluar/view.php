  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Modul Eksport Surat Keluar
        <small>Export Data</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?= base_url() ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Export Surat Keluar</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-danger">
        <div class="box-header with-border">
          <h3 class="box-title">Export Surat Keluar</h3>
                    ...
                    <div class='col-sm-9 col-md-8'>
                        ...
                        <div class="form-group">
                            <div class='col-sm-6'>
                                ...
                                <select name="jenis_surat" id="jenis_surat" class='form-control FormInput'>
                                    <option value="all">All</option>
                                    <?php foreach($jenis_surat as $dts){ ?>
                                    <option value="<?= $dts->Kode ?>"><?= $dts->Kode ?> - <?= $dts->Jenis ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class='col-sm-6'>
...
<?php $this->load->view('modul/eksport_surat_keluar/js'); ?>