                        ...
                        <?php $No=1; foreach($data as $dt){ ?>
                            <tr>
                                ...
                                <td width='10%' class='text-center'>
                                    <div class='btn-group'>
                                        <a  class='btn btn-xs btn-warning' data-toggle='tooltip' title='Detail Data Disposisi' href="<?= base_url('surat_masuk/detail_disposisi/'.$IdSuratMasuk."/".$dt->Id) ?>"><i class='fa fa-eye'></i></a>
                                        <?php if($this->session->userdata('KodeLevel') != 2){ ?>
                                        <a  class='btn btn-xs btn-primary' data-toggle='tooltip' title='Ubah Data' href="<?= base_url('surat_masuk/edit_disposisi/'.$IdSuratMasuk."/".$dt->Id) ?>"><i class='fa fa-edit'></i></a>
                                        <a onclick="return confirm('Anda yakin menghapus data ini?')" class='btn btn-xs btn-danger' data-toggle='tooltip' title='Hapus Data' href="<?= base_url('surat_masuk/delete_disposisi/'.$IdSuratMasuk."/".$dt->Id) ?>"><i class='fa fa-trash-o'></i></a>
                                        <?php } ?>
                                    </div>
                                </td>
                            </tr>
