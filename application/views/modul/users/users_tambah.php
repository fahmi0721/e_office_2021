                    ...
                    <div class='col-sm-9 col-md-8'>
                        ...
                        <div class="form-group">
                            <div class='col-sm-6'>
                                ...
                                <input class='form-control FormInput' type='text' autocomplete='off' placeholder='Nama Lengkap' name='Nama' id='Nama'>
                            </div>
                            <div class='col-sm-6'>
                        ...
                        <div class="form-group">
                            <div class='col-sm-6'>
                                ...
                                <div class='input-group'>
                                    ...
                                    <input type='text' autocomplete=off class='form-control FormInput' name='Username' id='Username' placeholder='Username' />
                                </div>
                            </div>
                            <div class='col-sm-6'>
                        ...
                        <div class="form-group">    
                            <div class='col-sm-6'>
                                ...
                                <div class='input-group'>
                                    <span class='input-group-addon'><input type='radio' name='Status' value='1' id='Status1' checked  /></span>
                                    <input type='text' readonly class='form-control' value='Aktif'  />
                                    <span class='input-group-addon'><input type='radio' name='Status' id='Status0' value='0'  /></span>
