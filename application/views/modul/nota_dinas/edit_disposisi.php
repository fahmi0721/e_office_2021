  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Modul Nota Dinas
        <small>Ubah Disposisi Nota Dinas</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <li class="active">Ubah Disposisi Nota Dinas</li>
    ...
    <section class="content">
      ...
      <div class="box box-danger">
        <div class="box-header with-border">
          <h3 class="box-title">Tambah Disposisi Nota Dinas</h3>
            ...
            <form id="FormDataDisposisiUpdate" class="form-horizontal" action="#">
                ...
                <div class='row'>
                    ...
                    <div class='col-sm-9 col-md-8'>
                        ...
                        <div class="form-group">
                            <div class="col-sm-6">
                                <label class="control-label">Disposisi <span class='text-danger'>*</span></label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class='col-sm-6'>
                                <label class="control-label">Disposisi Dari <span class='text-danger'>*</span></label>
                                <div class='input-group'>
                        ...
                        <div class="form-group">
                            <div class='col-sm-6'>
                                <label class="control-label">Tanggal Disposisi <span class='text-danger'>*</span></label>
                                <div class='input-group'>
