      ...
      <div class="box box-danger">
        ...
        <div class="box-body">
            ...
            <form id="FormDataDisposisiTambah" class="form-horizontal" action="#">
                <input value='<?= $data->Id; ?>'  class='form-control' type='hidden'  name='IdNotaDinas'>
                    ...
                    <div class='col-sm-3 col-md-4'>
                        <small>Catatan:
                            <ul>
                                ...
                                <li>lihat file suratnya <a class='btn btn-xs btn-success' target='_blank' href="<?= base_url('load_data/nota_dinas/'.$data->Id) ?>">disini</a></li>
                            </ul>
                        </small>
                    </div>
