  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Modul Klasifikasi
        <small>Ubah Klasifikasi</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?= base_url() ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?= base_url('klasifikasi/index/') ?>"><i class="fa fa-users"></i> Detail Klasifikasi</a></li>
        <li class="active">Ubah Klasifikasi</li>
    ...
    <section class="content">
      ...
      <div class="box box-danger">
        <div class="box-header with-border">
          <h3 class="box-title">Ubah Klasifikasi</h3>
                    ...
                    <div class='col-sm-9 col-md-8'>
                        ...
                        <div class="form-group">
                            ...
                            <div class='col-sm-6'>
                               ...
                               <input class='form-control FormInput' type='text' value='<?= $data->Nama ?>' autocomplete='off' placeholder='Nama' name='Nama' id='Nama'>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class='col-sm-12'>
  ...
  <?php $this->load->view('modul/klasifikasi/js'); ?>
